...
# In order to enable AMD graphics APIs in Windows containers, the host system must be running Radeon Adrenalin 21.7.1 or newer, 
# which was released on the 15th of July 2021. 
